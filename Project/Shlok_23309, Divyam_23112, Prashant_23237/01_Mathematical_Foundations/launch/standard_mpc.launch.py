"""
Launch file for Standard MPC controller.

Usage:
    ros2 launch mpc_controllers standard_mpc.launch.py
...
def generate_launch_description():
    ...
    # Standard MPC Node
    standard_mpc_node = Node(
        package='lcs',
        executable='standard_mpc_node',
        name='standard_mpc_node',
        output='screen',
        parameters=[{
            'horizon': 20,
            'dt': 0.05,
